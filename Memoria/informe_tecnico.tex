...
y sus predicciones con el modelo utilizado en el \textit{Prototipo 4}. El resultado obtenido fue de 0.9999, un valor que, según la literatura de referencia, indica una similitud estadística casi absoluta entre las distribuciones de audio.
