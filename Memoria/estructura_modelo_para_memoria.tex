...
\begin{figure}[H] 
\centering
\includegraphics[width=0.9\textwidth]{esquema_general.jpeg}
...
evitar chasquidos o artefactos indeseados. Finalmente, se aplican las dos transformaciones principales:
de audio a espectrograma y de amplitud lineal a logarítmica (dB). Esta función aplica una
