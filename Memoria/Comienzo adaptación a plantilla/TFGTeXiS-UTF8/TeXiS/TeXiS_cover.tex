...
\rule{\longTitulo}{.5mm}\\
\vskip 1cm
\parbox{\longTitulo}{\centering\Large\bfseries\tituloPortadaVal}\\[0.5cm]
\parbox{\longTitulo}{\centering\Large\tituloPortadaEngVal}
\vskip 0.7cm
\rule{\longTitulo}{.5mm}\\
\end{center}
\end{Large}
...
\autorPortadaVal\\[0.5cm]
{\Large \bfseries Directores}\\
\directorPortadaVal\\[0.5cm]
...
\mbox{ } \\ \mbox{ } \\ 
{\Large \bfseries Autores}\\
\autorPortadaVal\\[1.0cm]
{\Large \bfseries Directores}\\
\directorPortadaVal\\[0.3cm]
% {\Large \bfseries Colaborador}\\
