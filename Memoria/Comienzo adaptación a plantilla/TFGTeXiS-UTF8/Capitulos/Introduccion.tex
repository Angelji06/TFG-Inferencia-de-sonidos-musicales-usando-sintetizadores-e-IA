...
El objetivo principal del proyecto es desarrollar un sistema basado en \textbf{Redes Neuronales Convolucionales (CNNs)} capaz de estimar automáticamente los parámetros de un sintetizador de \textbf{modulación de frecuencia (FM)} a partir de una muestra de audio, con el fin de replicar su timbre.  
