...
La gráfica \ref{fig:test_set_p4} muestra unos valores de media y desviación estándar en ambas métricas que indican una muy baja consistencia. Visualmente, se puede observar una distribución de gran uniformidad en la métrica \textit{Mel L1} y también, en menor medida, en \textit{MCD}, lo que implica que la calidad de las predicciones varían mucho entre distintos tipos de audio. 
