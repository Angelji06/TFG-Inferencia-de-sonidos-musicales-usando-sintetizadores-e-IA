...
\textcolor{red}{FALTA MENCIONAR LAS PRUEBAS INICIALES CON PYO}
...
Así pues, los audios \textit{.wav} se convierten a tensores nativos de \textit{PyTorch}. Se cargan mediante \textit{torchaudio} y
...
Posteriormente, se extrae la magnitud de la señal, se convierte a decibelios (dB) y se guarda como tensores (formato \textit{.pt}). Además,
...
\textcolor{red}{FALTA HABLAR DE LOS PAPERS}
