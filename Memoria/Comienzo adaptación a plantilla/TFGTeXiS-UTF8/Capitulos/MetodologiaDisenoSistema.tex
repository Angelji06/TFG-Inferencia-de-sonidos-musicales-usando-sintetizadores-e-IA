...
Se sintetizan los N archivos \textit{.wav} mediante la librería \textbf{NumPy} y la formulación matemática de la FM (Fase 1). 
...
\textcolor{red}{FALTA mostrar los GEN PARAMS (figura)}
\textcolor{red}{FALTA mencionar pruebas inciales pyo}... 
Sin embargo se usó numpy de forma que todo el pipeline se
mantuviese unificado en un único programa python, además, debido a la naturaleza cambiante del programa, su simplicidad nos
permitía modificar el algoritmo de generación rápidamente. Por ejemplo, al principio del proyecto, cuando teníamos solo 3
...
Para la generación de envolventes...
\textcolor{red}{FALTA explicar algoritmos de generación de envolventes }
