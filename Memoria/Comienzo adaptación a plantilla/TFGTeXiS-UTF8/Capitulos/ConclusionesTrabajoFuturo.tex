...
Además, se ha demostrado que los espectrogramas mel funcionan mejor que los lineales tanto en términos perceptivos, al otorgar mejores resultados, como en términos computacionales, pues se requiere de un menor numero de \textit{bins} para generar su espectrograma.
...
\begin{enumerate}
\item \textbf{Implementación de un sintetizador diferenciable:} Cambiar el enfoque del proyecto hacia el uso y adaptación de DDSP (\textit{Differentiable Digital Signal Processing}), que permitiría integrar el proceso de síntesis directamente en el entrenamiento de la red. Esto posibilitaría un cálculo exacto en el descenso de gradiente (al no tratar el sintetizador como una ``caja negra''), optimizando la convergencia del modelo y mejorando notablemente la fidelidad de los resultados.
